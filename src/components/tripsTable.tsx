...
export default function TripTable() {
    ...
    return (
        <React.Fragment>
            ...
            >
                <FormControl size="sm">
                    <FormLabel>Search for trip</FormLabel>
            ...
            >
                ...
                >
                    <thead>
                        <tr>
                            <th style={{ width: "20%", padding: '12px 6px' }}>Section Name</th>
                            <th style={{ width: "20%", padding: '12px 6px' }}>category Name</th>
                            <th style={{ width: "20%", padding: '12px 6px' }}>trip Name</th>
                            <th style={{ width: "40%", padding: '12px 6px' }}>Added by</th>
                            <th style={{ width: "65%", padding: '12px 6px' }}>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        {stableSort(rows, getComparator("asc", 'id')).map((row) => (
                            <tr key={row.id}>
                                ...
                                <td>
                                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                                        <div>
                                            <Typography level="body-xs">{row.tripName}</Typography>
                                        </div>
                                    </Box>
                                </td>
                                ...
                                <td>
                                    <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                                        <Button style={{ backgroundColor: "green" }} onClick={() => x("/trips/updatetrip")} startDecorator={<EditRoundedIcon />}>update</Button>
