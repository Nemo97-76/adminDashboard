...
export default function SectionTable() {
    ...
    return (
        <React.Fragment>
            ...
            >
                <FormControl size="sm">
                    <FormLabel>Search for section</FormLabel>
                ...
                >
                    <thead>
                        <tr>
                            ...
                            <th style={{ width: "30%", padding: '12px 6px' }}>Added by</th>
                            <th style={{ width: "35%", padding: '12px 6px' }}>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr key={row.id}>
                                ...
                                <td>
                                    <Box sx={{ display: 'flex', gap: 2, alignItems: 'center' }}>
                                        <Button style={{ backgroundColor: "green" }} onClick={() => x("/sections/updatesection")} startDecorator={<EditRoundedIcon />}>update</Button>
